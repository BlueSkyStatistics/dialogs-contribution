...
class SampleSizeCorrelationNew extends baseModal {
    static dialogId = 'SampleSizeCorrelationNew'
    static t = baseModal.makeT(SampleSizeCorrelationNew.dialogId)

    constructor() {
        var config = {
            id: SampleSizeCorrelationNew.dialogId,
            label: SampleSizeCorrelationNew.t('title'),
...
`
        ...
        var objects = {
			howtouse: {
				el: new labelVar(config, {
					label: SampleSizeCorrelationNew.t('howtouse'), 
					style: "mb-3", 
					h:8
				})
			},
			n: {
				el: new input(config, {
					no: 'n',
					label: SampleSizeCorrelationNew.t('n'),
			...
			corr: {
				el: new input(config, {
					no: 'corr',
					label: SampleSizeCorrelationNew.t('corr'),
					value: "0.3",
			...
			power: {
				el: new input(config, {
					no: 'power',
					label: SampleSizeCorrelationNew.t('power'),
			...
			siglevel: {
				el: new input(config, {
					no: 'siglevel',
					label: SampleSizeCorrelationNew.t('siglevel'),
					style: "mt-5",
					placeholder: "0.05",
					extraction: "TextAsIs",
					type: "text",
			...
			alternativeopt: {
				el: new labelVar(config, {
					label: SampleSizeCorrelationNew.t('alternativeopt'), 
					style: "mt-5", 
					h:5
				})
			},
			twosided: {
				el: new radioButton(config, {
					label: SampleSizeCorrelationNew.t('twosided'),
					no: "altgrp",
					increment: "twosided",
					value: "two.sided",
					state: "checked",
			...
			greater: {
				el: new radioButton(config, {
					label: SampleSizeCorrelationNew.t('greater'),
					no: "altgrp",
					increment: "greater",
					value: "greater",
					state: "",
			...
			less: {
				el: new radioButton(config, {
					label: SampleSizeCorrelationNew.t('less'),
					no: "altgrp",
					increment: "less",
					value: "less",
					state: "",
			...
			plotopt: {
				el: new labelVar(config, {
					label: SampleSizeCorrelationNew.t('plotopt'),
					style: "mt-5",
					h:5
				})
			},
			plotcurve: {
				el: new checkbox(config, {
					no: 'plotcurve',
					label: SampleSizeCorrelationNew.t('plotcurve'),
					state: "",
					extraction: "TextAsIs"
				})
			},
			curvex: {
				  el: new selectVar(config, {
					no: 'curvex',
					label: SampleSizeCorrelationNew.t('curvex'),
			...
			curvegroup: {
				  el: new comboBox(config, {
					no: 'curvegroup',
					label: SampleSizeCorrelationNew.t('curvegroup'),
					multiple: true,
					extraction: "NoPrefix|UseComma",
			...
			mainTitle: {
                el: new input(config, {
                    no: "mainTitle",
                    label: SampleSizeCorrelationNew.t('mainTitle'),
                    allow_spaces: true,
			...
			xlab: {
                el: new input(config, {
                    no: 'xlab',
                    label: SampleSizeCorrelationNew.t('xlab'),
                    allow_spaces: true,
                    placeholder: "X Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			ylab: {
                el: new input(config, {
                    no: 'ylab',
                    label: SampleSizeCorrelationNew.t('ylab'),
                    allow_spaces: true,
                    placeholder: "Y Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			legends: {
                el: new selectVar(config, {
                    no: 'legends',
                    label: SampleSizeCorrelationNew.t('legends'),
                    multiple: false,
					extraction: "NoPrefix",
					required: false,
        ...
        const content = {
            ...
            nav: {
                name: SampleSizeCorrelationNew.t('navigation'),
                icon: "icon-link",
        ...
        this.help = {
            title: SampleSizeCorrelationNew.t('help.title'),
            r_help: SampleSizeCorrelationNew.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: SampleSizeCorrelationNew.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new SampleSizeCorrelationNew().render()
}
