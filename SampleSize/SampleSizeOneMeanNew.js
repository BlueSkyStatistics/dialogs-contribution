...
class SampleSizeOneMeanNew extends baseModal {
    static dialogId = 'SampleSizeOneMeanNew'
    static t = baseModal.makeT(SampleSizeOneMeanNew.dialogId)

    constructor() {
        var config = {
            id: SampleSizeOneMeanNew.dialogId,
            label: SampleSizeOneMeanNew.t('title'),
...
`
        ...
        var objects = {
			howtouse: {
				el: new labelVar(config, {
					label: SampleSizeOneMeanNew.t('howtouse'), 
					style: "mb-3", 
					h:8
				})
			},
			n: {
				el: new input(config, {
					no: 'n',
					label: SampleSizeOneMeanNew.t('n'),
			...
			delta: {
				el: new input(config, {
					no: 'delta',
					label: SampleSizeOneMeanNew.t('delta'),
			...
			power: {
				el: new input(config, {
					no: 'power',
					label: SampleSizeOneMeanNew.t('power'),
			...
			sd: {
				el: new input(config, {
					no: 'sd',
					label: SampleSizeOneMeanNew.t('sd'),
					style: "mt-5",
					placeholder: "",
					extraction: "TextAsIs",
					type: "text",
			...
			siglevel: {
				el: new input(config, {
					no: 'siglevel',
					label: SampleSizeOneMeanNew.t('siglevel'),
					placeholder: "0.05",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			alternativeopt: {
				el: new labelVar(config, {
					label: SampleSizeOneMeanNew.t('alternativeopt'), 
					style: "mt-5", 
					h:5
				})
			},
			twosided: {
				el: new radioButton(config, {
					label: SampleSizeOneMeanNew.t('twosided'),
					no: "altgrp",
					increment: "twosided",
					value: "two.sided",
					state: "checked",
			...
			onesided: {
				el: new radioButton(config, {
					label: SampleSizeOneMeanNew.t('onesided'),
					no: "altgrp",
					increment: "onesided",
					value: "one.sided",
					state: "",
			...
			plotopt: {
				el: new labelVar(config, {
					label: SampleSizeOneMeanNew.t('plotopt'),
					style: "mt-5",
					h:5
				})
			},
			plotcurve: {
				el: new checkbox(config, {
					no: 'plotcurve',
					label: SampleSizeOneMeanNew.t('plotcurve'),
					state: "",
					extraction: "TextAsIs"
				})
			},
			curvex: {
				  el: new selectVar(config, {
					no: 'curvex',
					label: SampleSizeOneMeanNew.t('curvex'),
			...
			curvegroup: {
				  el: new comboBox(config, {
					no: 'curvegroup',
					label: SampleSizeOneMeanNew.t('curvegroup'),
					multiple: true,
					extraction: "NoPrefix|UseComma",
			...
			mainTitle: {
                el: new input(config, {
                    no: "mainTitle",
                    label: SampleSizeOneMeanNew.t('mainTitle'),
                    allow_spaces: true,
			...
			xlab: {
                el: new input(config, {
                    no: 'xlab',
                    label: SampleSizeOneMeanNew.t('xlab'),
                    allow_spaces: true,
                    placeholder: "X Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			ylab: {
                el: new input(config, {
                    no: 'ylab',
                    label: SampleSizeOneMeanNew.t('ylab'),
                    allow_spaces: true,
                    placeholder: "Y Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			legends: {
                el: new selectVar(config, {
                    no: 'legends',
                    label: SampleSizeOneMeanNew.t('legends'),
                    multiple: false,
					extraction: "NoPrefix",
					required: false,
        ...
        const content = {
            ...
            nav: {
                name: SampleSizeOneMeanNew.t('navigation'),
                icon: "icon-t1",
        ...
        this.help = {
            title: SampleSizeOneMeanNew.t('help.title'),
            r_help: SampleSizeOneMeanNew.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: SampleSizeOneMeanNew.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new SampleSizeOneMeanNew().render()
}
