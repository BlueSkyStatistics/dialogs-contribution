...
class SampleSizeOnePropNew extends baseModal {
    static dialogId = 'SampleSizeOnePropNew'
    static t = baseModal.makeT(SampleSizeOnePropNew.dialogId)

    constructor() {
        var config = {
            id: SampleSizeOnePropNew.dialogId,
            label: SampleSizeOnePropNew.t('title'),
...
`
        ...
        var objects = {
			howtouse: {
				el: new labelVar(config, {
					label: SampleSizeOnePropNew.t('howtouse'), 
					style: "mb-3", 
					h:8
				})
			},
			n: {
				el: new input(config, {
					no: 'n',
					label: SampleSizeOnePropNew.t('n'),
			...
			power: {
				el: new input(config, {
					no: 'power',
					label: SampleSizeOnePropNew.t('power'),
			...
			prop: {
				el: new input(config, {
					no: 'prop',
					label: SampleSizeOnePropNew.t('prop'),
					required: true,
					style: "mt-5",
			...
			prop0: {
				el: new input(config, {
					no: 'prop0',
					label: SampleSizeOnePropNew.t('prop0'),
					required: true,
					placeholder: "e.g. 0.2",
					extraction: "TextAsIs",
					type: "text",
			...
			siglevel: {
				el: new input(config, {
					no: 'siglevel',
					label: SampleSizeOnePropNew.t('siglevel'),
					placeholder: "0.05",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			alternativeopt: {
				el: new labelVar(config, {
					label: SampleSizeOnePropNew.t('alternativeopt'), 
					style: "mt-5", 
					h:5
				})
			},
			twosided: {
				el: new radioButton(config, {
					label: SampleSizeOnePropNew.t('twosided'),
					no: "altgrp",
					increment: "twosided",
					value: "two.sided",
					state: "checked",
			...
			onesided: {
				el: new radioButton(config, {
					label: SampleSizeOnePropNew.t('onesided'),
					no: "altgrp",
					increment: "onesided",
					value: "one.sided",
					state: "",
			...
			plotopt: {
				el: new labelVar(config, {
					label: SampleSizeOnePropNew.t('plotopt'),
					style: "mt-5",
					h:5
				})
			},
			plotcurve: {
				el: new checkbox(config, {
					no: 'plotcurve',
					label: SampleSizeOnePropNew.t('plotcurve'),
					state: "",
					extraction: "TextAsIs"
				})
			},
			curvex: {
				  el: new selectVar(config, {
					no: 'curvex',
					label: SampleSizeOnePropNew.t('curvex'),
			...
			curvegroup: {
				  el: new comboBox(config, {
					no: 'curvegroup',
					label: SampleSizeOnePropNew.t('curvegroup'),
					multiple: true,
					extraction: "NoPrefix|UseComma",
			...
			mainTitle: {
                el: new input(config, {
                    no: "mainTitle",
                    label: SampleSizeOnePropNew.t('mainTitle'),
                    allow_spaces: true,
			...
			xlab: {
                el: new input(config, {
                    no: 'xlab',
                    label: SampleSizeOnePropNew.t('xlab'),
                    allow_spaces: true,
                    placeholder: "X Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			ylab: {
                el: new input(config, {
                    no: 'ylab',
                    label: SampleSizeOnePropNew.t('ylab'),
                    allow_spaces: true,
                    placeholder: "Y Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			legends: {
                el: new selectVar(config, {
                    no: 'legends',
                    label: SampleSizeOnePropNew.t('legends'),
                    multiple: false,
					extraction: "NoPrefix",
					required: false,
        ...
        const content = {
            ...
            nav: {
                name: SampleSizeOnePropNew.t('navigation'),
                icon: "icon-p1",
        ...
        this.help = {
            title: SampleSizeOnePropNew.t('help.title'),
            r_help: SampleSizeOnePropNew.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: SampleSizeOnePropNew.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new SampleSizeOnePropNew().render()
}
