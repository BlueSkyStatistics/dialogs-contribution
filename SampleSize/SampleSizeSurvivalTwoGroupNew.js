...
class SampleSizeSurvivalTwoGroupNew extends baseModal {
    static dialogId = 'SampleSizeSurvivalTwoGroupNew'
    static t = baseModal.makeT(SampleSizeSurvivalTwoGroupNew.dialogId)

    constructor() {
        var config = {
            id: SampleSizeSurvivalTwoGroupNew.dialogId,
            label: SampleSizeSurvivalTwoGroupNew.t('title'),
...
`
        ...
        var objects = {
			howtouse: {
				el: new labelVar(config, {
					label: SampleSizeSurvivalTwoGroupNew.t('howtouse'), 
					style: "mb-3", 
					h:8
				})
			},
			n: {
				el: new input(config, {
					no: 'n',
					label: SampleSizeSurvivalTwoGroupNew.t('n'),
			...
			power: {
				el: new input(config, {
					no: 'power',
					label: SampleSizeSurvivalTwoGroupNew.t('power'),
			...
			propgrp1: {
				el: new input(config, {
					no: 'propgrp1',
					label: SampleSizeSurvivalTwoGroupNew.t('propgrp1'),
					style: "mt-5",
					required: true,
			...
			hr: {
				el: new input(config, {
					no: 'hr',
					label: SampleSizeSurvivalTwoGroupNew.t('hr'),
					required: true,
			...
			propevent: {
				el: new input(config, {
					no: 'propevent',
					label: SampleSizeSurvivalTwoGroupNew.t('propevent'),
					required: true,
			...
			rsquared: {
				el: new input(config, {
					no: 'rsquared',
					label: SampleSizeSurvivalTwoGroupNew.t('rsquared'),
					required: true,
			...
			siglevel: {
				el: new input(config, {
					no: 'siglevel',
					label: SampleSizeSurvivalTwoGroupNew.t('siglevel'),
					placeholder: "0.05",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			alternativeopt: {
				el: new labelVar(config, {
					label: SampleSizeSurvivalTwoGroupNew.t('alternativeopt'), 
					style: "mt-5", 
					h:5
				})
			},
			twosided: {
				el: new radioButton(config, {
					label: SampleSizeSurvivalTwoGroupNew.t('twosided'),
					no: "altgrp",
					increment: "twosided",
					value: "2",
					state: "checked",
			...
			onesided: {
				el: new radioButton(config, {
					label: SampleSizeSurvivalTwoGroupNew.t('onesided'),
					no: "altgrp",
					increment: "onesided",
					value: "1",
					state: "",
			...
			plotopt: {
				el: new labelVar(config, {
					label: SampleSizeSurvivalTwoGroupNew.t('plotopt'),
					style: "mt-5",
					h:5
				})
			},
			plotcurve: {
				el: new checkbox(config, {
					no: 'plotcurve',
					label: SampleSizeSurvivalTwoGroupNew.t('plotcurve'),
					state: "",
					extraction: "TextAsIs"
				})
			},
			curvex: {
				  el: new selectVar(config, {
					no: 'curvex',
					label: SampleSizeSurvivalTwoGroupNew.t('curvex'),
			...
			curvegroup: {
				  el: new comboBox(config, {
					no: 'curvegroup',
					label: SampleSizeSurvivalTwoGroupNew.t('curvegroup'),
					multiple: true,
					extraction: "NoPrefix|UseComma",
			...
			mainTitle: {
                el: new input(config, {
                    no: "mainTitle",
                    label: SampleSizeSurvivalTwoGroupNew.t('mainTitle'),
                    allow_spaces: true,
			...
			xlab: {
                el: new input(config, {
                    no: 'xlab',
                    label: SampleSizeSurvivalTwoGroupNew.t('xlab'),
                    allow_spaces: true,
                    placeholder: "X Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			ylab: {
                el: new input(config, {
                    no: 'ylab',
                    label: SampleSizeSurvivalTwoGroupNew.t('ylab'),
                    allow_spaces: true,
                    placeholder: "Y Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			legends: {
                el: new selectVar(config, {
                    no: 'legends',
                    label: SampleSizeSurvivalTwoGroupNew.t('legends'),
                    multiple: false,
					extraction: "NoPrefix",
					required: false,
        ...
        const content = {
            ...
            nav: {
                name: SampleSizeSurvivalTwoGroupNew.t('navigation'),
                icon: "icon-kaplanc",
        ...
        this.help = {
            title: SampleSizeSurvivalTwoGroupNew.t('help.title'),
            r_help: SampleSizeSurvivalTwoGroupNew.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: SampleSizeSurvivalTwoGroupNew.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new SampleSizeSurvivalTwoGroupNew().render()
}
