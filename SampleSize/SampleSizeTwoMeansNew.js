...
class SampleSizeTwoMeansNew extends baseModal {
    static dialogId = 'SampleSizeTwoMeansNew'
    static t = baseModal.makeT(SampleSizeTwoMeansNew.dialogId)

    constructor() {
        var config = {
            id: SampleSizeTwoMeansNew.dialogId,
            label: SampleSizeTwoMeansNew.t('title'),
...
`
        ...
        var objects = {
			howtouse: {
				...
				el: new labelVar(config, {
					no: "howtouse",
					label: SampleSizeTwoMeansNew.t('howtouse'), 
					h: 6
				})
			},
			n: {
				el: new input(config, {
					no: 'n',
					label: SampleSizeTwoMeansNew.t('n'),
			...
			power: {
				el: new input(config, {
					no: 'power',
					label: SampleSizeTwoMeansNew.t('power'),
			...
			meangrp1: {
				el: new input(config, {
					no: 'meangrp1',
					label: SampleSizeTwoMeansNew.t('meangrp1'),
			...
			meangrp2: {
				el: new input(config, {
					no: 'meangrp2',
					label: SampleSizeTwoMeansNew.t('meangrp2'),
					placeholder: "e.g. 9",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			ratio: {
				el: new input(config, {
					no: 'ratio',
					label: SampleSizeTwoMeansNew.t('ratio'),
					style: "mt-5",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			sd: {
				el: new input(config, {
					no: 'sd',
					label: SampleSizeTwoMeansNew.t('sd'),
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
					required: true,
			...
			siglevel: {
				el: new input(config, {
					no: 'siglevel',
					label: SampleSizeTwoMeansNew.t('siglevel'),
					placeholder: "0.05",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			alternativeopt: {
				el: new labelVar(config, {
					label: SampleSizeTwoMeansNew.t('alternativeopt'), 
					style: "mt-5", 
					h:5
				})
			},
			twosided: {
				el: new radioButton(config, {
					label: SampleSizeTwoMeansNew.t('twosided'),
					no: "altgrp",
					increment: "twosided",
					value: "2",
					state: "checked",
			...
			onesided: {
				el: new radioButton(config, {
					label: SampleSizeTwoMeansNew.t('onesided'),
					no: "altgrp",
					increment: "onesided",
					value: "1",
					state: "",
			...
			plotopt: {
				el: new labelVar(config, {
					label: SampleSizeTwoMeansNew.t('plotopt'),
					style: "mt-5",
					h:5
				})
			},
			plotcurve: {
				el: new checkbox(config, {
					no: 'plotcurve',
					label: SampleSizeTwoMeansNew.t('plotcurve'),
					state: "",
					extraction: "TextAsIs"
				})
			},
			...
			curvex: {
				  el: new selectVar(config, {
					no: 'curvex',
					label: SampleSizeTwoMeansNew.t('curvex'),
					extraction: "NoPrefix|UseComma",
			...
			curvegroup: {
				  el: new comboBox(config, {
					no: 'curvegroup',
					label: SampleSizeTwoMeansNew.t('curvegroup'),
					multiple: true,
					extraction: "NoPrefix|UseComma",
			...
			mainTitle: {
                el: new input(config, {
                    no: "mainTitle",
                    label: SampleSizeTwoMeansNew.t('mainTitle'),
                    allow_spaces: true,
			...
			xlab: {
                el: new input(config, {
                    no: 'xlab',
                    label: SampleSizeTwoMeansNew.t('xlab'),
                    allow_spaces: true,
                    placeholder: "X Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			ylab: {
                el: new input(config, {
                    no: 'ylab',
                    label: SampleSizeTwoMeansNew.t('ylab'),
                    allow_spaces: true,
                    placeholder: "Y Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			legends: {
                el: new selectVar(config, {
                    no: 'legends',
                    label: SampleSizeTwoMeansNew.t('legends'),
                    multiple: false,
					extraction: "NoPrefix",
					required: false,
        ...
        const content = {
            ...
            nav: {
                name: SampleSizeTwoMeansNew.t('navigation'),
                icon: "icon-t2",
        ...
        this.help = {
            title: SampleSizeTwoMeansNew.t('help.title'),
            r_help: SampleSizeTwoMeansNew.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: SampleSizeTwoMeansNew.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new SampleSizeTwoMeansNew().render()
}
