...
class SampleSizeTwoPairedPropNew extends baseModal {
    static dialogId = 'SampleSizeTwoPairedPropNew'
    static t = baseModal.makeT(SampleSizeTwoPairedPropNew.dialogId)

    constructor() {
        var config = {
            id: SampleSizeTwoPairedPropNew.dialogId,
            label: SampleSizeTwoPairedPropNew.t('title'),
...
`
        ...
        var objects = {
			howtouse: {
				el: new labelVar(config, {
					label: SampleSizeTwoPairedPropNew.t('howtouse'), 
					style: "mb-3", 
					h:8
				})
			},
			n: {
				el: new input(config, {
					no: 'n',
					label: SampleSizeTwoPairedPropNew.t('n'),
			...
			power: {
				el: new input(config, {
					no: 'power',
					label: SampleSizeTwoPairedPropNew.t('power'),
			...
			pdisc: {
				el: new input(config, {
					no: 'pdisc',
					label: SampleSizeTwoPairedPropNew.t('pdisc'),
					style: "mt-5",
					required: true,
			...
			pdiff: {
				el: new input(config, {
					no: 'pdiff',
					label: SampleSizeTwoPairedPropNew.t('pdiff'),
					required: true,
			...
			siglevel: {
				el: new input(config, {
					no: 'siglevel',
					label: SampleSizeTwoPairedPropNew.t('siglevel'),
					placeholder: "0.05",
					extraction: "TextAsIs",
					type: "text",
					allow_spaces: true,
			...
			alternativeopt: {
				el: new labelVar(config, {
					label: SampleSizeTwoPairedPropNew.t('alternativeopt'), 
					style: "mt-5", 
					h:5
				})
			},
			twosided: {
				el: new radioButton(config, {
					label: SampleSizeTwoPairedPropNew.t('twosided'),
					no: "altgrp",
					increment: "twosided",
					value: "2",
					state: "checked",
			...
			onesided: {
				el: new radioButton(config, {
					label: SampleSizeTwoPairedPropNew.t('onesided'),
					no: "altgrp",
					increment: "onesided",
					value: "1",
					state: "",
			...
			plotopt: {
				el: new labelVar(config, {
					label: SampleSizeTwoPairedPropNew.t('plotopt'),
					style: "mt-5",
					h:5
				})
			},
			plotcurve: {
				el: new checkbox(config, {
					no: 'plotcurve',
					label: SampleSizeTwoPairedPropNew.t('plotcurve'),
					state: "",
					extraction: "TextAsIs"
				})
			},
			curvex: {
				  el: new selectVar(config, {
					no: 'curvex',
					label: SampleSizeTwoPairedPropNew.t('curvex'),
			...
			curvegroup: {
				  el: new comboBox(config, {
					no: 'curvegroup',
					label: SampleSizeTwoPairedPropNew.t('curvegroup'),
					multiple: true,
					extraction: "NoPrefix|UseComma",
			...
			mainTitle: {
                el: new input(config, {
                    no: "mainTitle",
                    label: SampleSizeTwoPairedPropNew.t('mainTitle'),
                    allow_spaces: true,
			...
			xlab: {
                el: new input(config, {
                    no: 'xlab',
                    label: SampleSizeTwoPairedPropNew.t('xlab'),
                    allow_spaces: true,
                    placeholder: "X Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			ylab: {
                el: new input(config, {
                    no: 'ylab',
                    label: SampleSizeTwoPairedPropNew.t('ylab'),
                    allow_spaces: true,
                    placeholder: "Y Axis",
                    extraction: "NoPrefix|UseComma",
					value: ""
			...
			legends: {
                el: new selectVar(config, {
                    no: 'legends',
                    label: SampleSizeTwoPairedPropNew.t('legends'),
                    multiple: false,
					extraction: "NoPrefix",
					required: false,
        ...
        const content = {
            ...
            nav: {
                name: SampleSizeTwoPairedPropNew.t('navigation'),
        ...
        this.help = {
            title: SampleSizeTwoPairedPropNew.t('help.title'),
            r_help: SampleSizeTwoPairedPropNew.t('help.r_help'), //Fix by Anil //r_help: "help(data,package='utils')",
            body: SampleSizeTwoPairedPropNew.t('help.body')
        }
;
    }
...
module.exports = {
    render: () => new SampleSizeTwoPairedPropNew().render()
}
